...
export default function NavBar({ data }) {
  ...
  return (<>
    <nav className="fixed z-30 top-0 inset-x-0 h-14 lg:h-16 bg-gradient-to-b from-slate-900 to-[#02001A]-900/90 flex items-center justify-between lg:px-24 px-6 backdrop-blur">
